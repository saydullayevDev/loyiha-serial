...
function clas() {
  //! Class / ...rest operator / default qiymat
    ...
    _createClass(MenuCard, [{
      ...
      value: function render() {
        ...
        if (this.classes.length === 0) {
          this.element = 'menu__item'; //! default qiymat
...
function form(formSelector, modalTimerId) {
  ...
  function bindpostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var formData = new FormData(form); //* FormData() {object} qaytaradi yani from-ning [name]-larini obyekt qilib qaytaradi|
...
function timer(id, deadLine) {
  ...
  // console.log(Date.parse(deadLine)) //* ml secundga aylantirib beradi
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2024-03-30');
});
})();
